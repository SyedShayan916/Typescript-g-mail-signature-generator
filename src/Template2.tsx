...
const template2: React.FC<IProps> = (props)=>{
    ...
    const copyDiv = () =>{
      ...
      range.selectNode(document.getElementById("template2"));
    ...
    return(
        ...
        <div className='container'>
          ...
          <div className='form' id='template2' style={{ fontFamily: selectedFont,fontSize:fontSize }}>
            <div style={{display: 'flex',flexDirection: 'column',alignItems: 'center'}}>
            <img src={img} style={{borderRadius:'100px',marginBottom:'20px',color:'red',background:'red',width:'100px',height:'100px'}} />           
              <div style={{lineHeight:'8px',paddingRight:'20px',color:selectedColortext,textAlign:'center'}}>
            ...
            <hr style={{border:'none',padding:'.1px', background:selectedColorcolor, width:'500px'}}/>            
                <div style={{display:'flex',justifyContent: 'space-between',padding:'10px 0'}}>
                    ...
                    <div style={{display: 'flex',justifyContent: 'space-between',paddingTop: "20px",alignItems: 'center',flexDirection: 'column'}}>
            ...
            <div style={{display:'flex',justifyContent: "space-between"}}>
              <p style={{ display: isSwitchOn ? 'none' : 'block',paddingLeft:'140px' }}><a href="" style={{color:selectedColortext,textDecoration: 'none'}}>Create Your Own Free Signature</a></p>
              <button
