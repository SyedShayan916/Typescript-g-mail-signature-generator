...
const template6: React.FC<IProps> = (props)=>{
    const{
    selectedFont,
    fontSize,
    selectedColorcolor,
    ...
    const copyDiv = () =>{
      ...
      range.selectNode(document.getElementById("template5"));
    ...
    return(
        ...
        <div className='container'>
          ...
          <div className='form' id='template5' style={{ fontFamily: selectedFont,fontSize:fontSize }}>
            ...
            <hr style={{border:'none',width:'400px',padding:'.1px', background:selectedColorcolor}}/>            
