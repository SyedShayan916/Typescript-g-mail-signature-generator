...
const template3: React.FC<IProps> = (props)=>{
    const{
    selectedFont,
    fontSize,
    selectedColorcolor,
...
const copyDiv = () =>{
  ...
  range.selectNode(document.getElementById("template3"));
  ...
  toast.success('Signature copied!', {
    ...
    return(
        ...
        <div className='container'>
          ...
          <div className='form' id='template3' style={{ fontFamily: selectedFont,fontSize:fontSize,}}>
            
              <div style={{display:"flex",alignItems: 'center'}}>
                <img src={img} style={{borderRadius:'100px',marginBottom:'20px',color:'red',background:'red',width:'100px',height:'100px'}} />           
                <div style={{lineHeight:'8px',padding:'0 30px',color:selectedColortext}}>
                ...
                <hr style={{border:'none',height:'150px',padding:'.1px', background:selectedColorcolor}}/>            
                <div style={{paddingLeft:'20px',color:selectedColortext}}>
